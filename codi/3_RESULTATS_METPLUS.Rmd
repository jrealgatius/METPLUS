...
ggsave(here::here(dir_resultats,"figure_covariate.tiff"),Covariable_Balance)
ggsave(here::here(dir_resultats,"figure_covariate.png"),Covariable_Balance)
...
## Diferencias estandarizadas entre grupos 2 a 2 
...
forest_plot_Panel<-forest_plot_Panel+labs(caption="Magnitude of effect size by Cohen's f: Small: <0.10; Medium: 0.25; Large: >0.4")

forest_plot_Panel

ggsave(here::here(dir_resultats,"figure_ForestPlot.tiff"),forest_plot_Panel,width = 14,height = 10)
ggsave(here::here(dir_resultats,"figure_ForestPlot.png"),forest_plot_Panel,width = 14,height = 10)
